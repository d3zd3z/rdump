...
SQLITE3 = target/deps/$(shell $(RUSTC) --crate-file-name $(SQLITE3_PATH)/src/sqlite3/lib.rs)
LIBPOOL = target/$(shell $(RUSTC) --crate-type=lib --crate-file-name src/libpool/lib.rs)
